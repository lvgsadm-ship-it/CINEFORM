...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        DB::table('taller_cursos')->insert([
            [
                'nombre' => 'Manejo de Cámaras',
                'id_modalidad' => 1,
                'id_persona' => 2,
                'duracion' => 5,
                'horas' => 5,
                'cantidad_cupos' => 10,
                'descripcion' => 'Manejo de Cámaras, técnicas y tipos de manejo.',
            ...
            [
                'nombre' => 'Introduccion a la Cinematografia',
                'id_modalidad' => 1,
                'id_persona' => 2,
                'duracion' => 5,
                'horas' => 5,
                'cantidad_cupos' => 10,
                'descripcion' => 'Introduccion a la Cinematografia.',
                'fecha_inicio' => '2025-11-13',
                'fecha_fin' => '2025-11-30',
                'creado_por' => 'Nicolas',
                'creado_en' => now(),
