    ...
    public function edit($id)
{
    ...
    return view('taller::a.CursoEditar', compact('curso', 'modalidades', 'contenidos'));
}
                    ...
                    if (!empty($contenidoData['id'])) {
                        ...
                        if ($contenido) {
                            $updateData = [
                                ...
                                'orden' => $contenidoData['orden'] ?? $index
                            ];
                            
                            // Solo actualizar descripcion_breve si existe en el request
                            if (isset($contenidoData['descripcion_breve'])) {
                                $updateData['descripcion_breve'] = $contenidoData['descripcion_breve'];
                            }
                            
                            $contenido->update($updateData);
                            Log::debug('Contenido actualizado:', $contenido->toArray());
                        }
                    } else {
                        // Crear nuevo contenido
                        $nuevoContenido = $curso->contenidos()->create([
                            'titulo' => $contenidoData['titulo'],
                            'url_contenido' => $contenidoData['url_contenido'],
                            'descripcion' => $contenidoData['descripcion'] ?? $contenidoData['descripcion_breve'] ?? null,
