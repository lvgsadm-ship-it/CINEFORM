            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="fecha_inicio" name="fecha_inicio" 
                           value="{{ old('fecha_inicio', $curso->fecha_inicio ? $curso->fecha_inicio->format('Y-m-d') : '') }}" readonly>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="fecha_fin" name="fecha_fin" 
                           value="{{ old('fecha_fin', $curso->fecha_fin ? $curso->fecha_fin->format('Y-m-d') : '') }}" readonly>
                </div>
            </div>
        </div>
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <div id="contenidos-container">
               ads @foreach($contenidos as $index => $contenido)
                <div class="contenido-item mb-3 border p-3" data-index="{{ $index }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="url" name="contenidos[{{ $index }}][url_contenido]" 
                                       class="form-control" value="{{ $contenido->url_contenido }}" required>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input type="number" name="contenidos[{{ $index }}][orden]" 
                                       class="form-control" value="{{ $contenido->orden ?? $loop->index + 1 }}" min="1">
                            </div>
                        </div>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <textarea name="contenidos[{{ $index }}][descripcion]" 
                                 class="form-control" rows="2">{{ $contenido->descripcion }}</textarea>
                    </div>
                    <div class="form-group mt-2">
